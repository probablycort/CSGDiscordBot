...
async def statuses():
    ...
    await client.change_presence(activity=discord.Game('v2.1a | .help'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('that one crazy ass game that people talked about'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('UNDERTALE'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('water.'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('fart'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('[stupid ass status here]'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('do NOT abuse me. please.'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('Hello World'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('please give me some song suggestions'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('nothing. i\'m bored'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('who is asyncio and why is it sleeping for 60 sec'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('HAWK TUAH 2: the sequel'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('fortnite i guess'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('too much statuses.. send help'))
    await asyncio.sleep(60)
